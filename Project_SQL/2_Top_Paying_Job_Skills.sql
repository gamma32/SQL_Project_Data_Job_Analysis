...
select TPJ.* 
    , SD.skills, SD.type
from TopPayingJobs TPJ 
    inner join skills_job_dim SJD   using (job_id) -- on TPJ.job_id=SJD.job_id
    inner join skills_dim SD        using (skill_id) -- on SJD.skill_id=SD.skill_id
